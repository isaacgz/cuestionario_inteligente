        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade show active" id="kt_topbar_notifications_1" role="tabpanel">
                ...
                <div class="scroll-y mh-325px my-5 px-8">
                    ...
                    <div class="d-flex flex-stack py-4">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <!--begin::Title-->
                            <div class="mb-0 me-2">
                                <a href="#" class="fs-6 text-gray-800 text-hover-primary fw-bolder">Articulos</a>
                                <div class="text-gray-400 fs-7">Articulos por debajo del stock</div>
                            </div>
                            <!--end::Title-->
                        </div>
                        <!--end::Section-->
                ...
                <div class="py-3 text-center border-top">
                    <a href="../../demo1/dist/pages/profile/activity.html" class="btn btn-color-gray-600 btn-active-color-primary">Ver todo
