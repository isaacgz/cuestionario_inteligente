...
<div class="toolbar" id="kt_toolbar">
    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
            <!--begin::Title-->
            <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Datos fiscales</h1>
            <!--end::Title-->
            <!--begin::Separator-->
            ...
            <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                ...
                <!--begin::Item-->
                <li class="breadcrumb-item text-muted">
                    <li class="breadcrumb-item text-muted">Datos fiscales</li>
                </li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <div class="card" id="data_tab_brancho">
            ...
            <div class="card card-custom">
                <div class="card-header py-3">
                    <div class="card-title">
                        ...
                        <h3 class="card-label">Mis Datos fiscales</h3>
                    </div>
                    <div class="card-toolbar">                                        
                        <!--begin::Button-->
                        <button class="btn btn-primary font-weight-bolder mx-4 font-size-sm" data-kt-element="modal-open" data-bs-toggle="modal" data-bs-target="#kt_modal_new_td">                        
                        ...
                        <!--end::Button-->
                        <!--begin::Modal-->
                        @include('taxdata.modal_add')
                        @include('taxdata.modal_edit') 
                        <!--end::Modal-->
                    </div>
                </div>
            </div>
            ...
            <div class="card-body pt-6">
                <table id="kt_datatable_td" class="table align-middle table-row-dashed fs-7 gy-3">
                    <thead>
...
<script src="{{ asset('assets/js/system/tax_data/crud_tax_data_add.js')}}"></script>
<script src="{{ asset('assets/js/system/tax_data/crud_tax_data_validate.js')}}"></script>
<script src="{{ asset('assets/js/system/tax_data/crud_tax_data_datatable.js')}}"></script>
<script src="{{ asset('assets/js/system/tax_data/crud_tax_data_delete.js')}}"></script>
<script src="{{ asset('assets/js/system/tax_data/crud_tax_data.js')}}"></script>
<script>
    window.onload = getTaxData;    
</script>
@endsection