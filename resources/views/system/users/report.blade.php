    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <div class="card" id="data_tab_brancho">
            ...
            <div class="card card-custom">
                <div class="card-header py-3">
                    <div class="card-title">
                        ...
                        <h3 class="card-label">Reporte General - Usuarios</h3>
                    </div>
                    <div class="card-toolbar">
                        <!--begin::Button-->
                            {{-- <a href="{{ route("users.import") }}" class="btn btn-light-success">Carga Masiva</a> --}}
                        <!--end::Button-->
                                        
                        <!--begin::Button-->
                        <button class="btn btn-primary er fs-6 px-8 py-4" data-bs-toggle="modal" data-bs-target="#kt_modal_new_user">
                        ...
                        <!--end::Button-->
                        <!--begin::Modal-->
                        @include('system.users.modal_add')
                        @include('system.users.modal_edit') 
                        <!--end::Modal-->
                    </div>
                </div>
            </div>
            ...
            <div class="card-body pt-6">
                <table id="kt_datatable_user" class="table align-middle table-row-dashed fs-7 gy-3">
                    <thead>
...
<script src="{{ asset('assets/js/system/users/crud_user.js')}}"></script>
<script src="{{ asset('assets/js/system/users/crud_user_validate.js')}}"></script>
<script src="{{ asset('assets/js/system/users/crud_user_datatable.js')}}"></script>
<script>
