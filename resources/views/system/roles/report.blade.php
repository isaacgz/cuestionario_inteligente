    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <div class="card" id="data_tab_brancho">
            ...
            <div class="card card-custom">
                <div class="card-header py-3">
                    <div class="card-title">
                        ...
                        <h3 class="card-label">Reporte General - Roles</h3>
                    </div>
                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <button class="btn btn-primary er fs-6 px-8 py-4" data-bs-toggle="modal" data-bs-target="#kt_modal_new_role">
                        ...
                        <!--end::Button-->
                        <!--begin::Modal-->
                        @include('system.roles.modal_add')
                        @include('system.roles.modal_edit') 
                        <!--end::Modal-->
                    </div>
                </div>
            </div>
            ...
            <div class="card-body pt-6">
                <table id="kt_datatable_roles" class="table align-middle table-row-dashed fs-7 gy-3">
                    <thead>
...
<script src="{{ asset('assets/js/system/roles/crud_roles.js')}}"></script>
<script src="{{ asset('assets/js/system/roles/crud_roles_datatable.js')}}"></script>
<script>
    window.onload = get_roles;    
</script>
@endsection