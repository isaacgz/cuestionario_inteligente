...
class CustomerInvoiceController extends Controller
{
    ...
    {
        $this->middleware('permission:Ver_FacturasClientes|Crear_FacturasClientes|Editar_FacturasClientes|Eliminar_FacturasClientes',['only' => ['index']]);
        $this->middleware('permission:Crear_FacturasClientes',['only' => ['create', 'store']]);
        $this->middleware('permission:Editar_FacturasClientes',['only' => ['edit', 'update']]);
        $this->middleware('permission:Eliminar_FacturasClientes',['only' => ['destroy']]);
    }
    /**
    ...
    {              
        ...
        return view('admin.invoice.customer.report');
    }
