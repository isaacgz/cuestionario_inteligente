...
var KTSigninGeneral = function () {
  ...
  return {
    init: function init() {
      t = document.querySelector("#form_login"), e = document.querySelector("#kt_sign_in_submit"), i = FormValidation.formValidation(t, {
        fields: {
          email: {
            validators: {
              notEmpty: {
              ...
              emailAddress: {
                message: "El campo correo electrónico no es una dirección válida."
              }
            }
          },
          password: {
